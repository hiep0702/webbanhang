                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" style="width: 100%;" value="{{$pro->product_name}}" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá sản phẩm</label><br>
                                <input type="text" name="product_price" class="form-control" id="exampleInputEmail1" style="width: 100%;" value="{{$pro->product_price}}" >
                            </div>
                            <div class="form-group">

                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/save-product')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min6" data-validation-error-msg="Làm ơn điền ít nhất 6 ký tự"  name="product_name" class="form-control" id="exampleInputEmail1" style="width: 100%;" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá sản phẩm</label><br>
                                <input type="text" data-validation="number"  data-validation-error-msg="Vui lòng nhập giá" name="product_price" class="form-control" id="exampleInputEmail1" style="width: 100%;" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hình ảnh sản phẩm</label><br>
                                <input type="file" name="product_image" class="form-control" id="exampleInputEmail1" style="width: 100%;" >
                            </div>
                            <div class="form-group">
